...
Este repositório documenta o **AccessOps Framework: Acessibilidade Digital Contínua**, metodologia autoral desenvolvida por **Danilo Souza** para estruturar processos contínuos de acessibilidade digital em produtos e serviços digitais.

A proposta parte da compreensão de que produtos digitais mudam continuamente e, por isso, a acessibilidade também precisa ser planejada, avaliada, corrigida, monitorada e reavaliada de forma contínua.

O AccessOps desloca a acessibilidade da lógica de validação pontual para uma lógica de operação permanente, integrada à rotina de gestão, desenvolvimento, QA, UX, conteúdo, governança e melhoria contínua.
...
O conteúdo deste projeto é disponibilizado sob a licença **Creative Commons Atribuição-NãoComercial 4.0 Internacional (CC BY-NC 4.0)**.

O uso, compartilhamento e adaptação são permitidos para fins não comerciais, desde que seja atribuída a autoria a **Danilo Souza** e indicada a fonte original.
...
Licença: https://creativecommons.org/licenses/by-nc/4.0/deed.pt-br
